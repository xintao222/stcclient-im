 ...
 * 
 */
public class IntTLVEncoder extends AbstractNumberTLVEncoder implements
		TLVEncoder {

	// @SuppressWarnings("unused")
	// private static final Logger logger =
	// LoggerFactory.getLogger(IntTLVEncoder.class);
	...
	public List<byte[]> encode(Object from, TLVEncodeContext ctx) {
		...
		if (from instanceof Integer) {
			...
			throw new RuntimeException("IntTLVEncoder: wrong source type. ["
					+ from.getClass() + "]");
		}
