 ...
 * 
 */
public class ByteTLVEncoder extends AbstractNumberTLVEncoder implements
		TLVEncoder {

	// @SuppressWarnings("unused")
	// private static final Logger logger =
	// LoggerFactory.getLogger(ByteTLVEncoder.class);
	...
	public List<byte[]> encode(Object from, TLVEncodeContext ctx) {
		...
		if (from instanceof Short) {
			...
			throw new RuntimeException("ByteTLVEncoder: wrong source type. ["
					+ from.getClass() + "]");
		}
