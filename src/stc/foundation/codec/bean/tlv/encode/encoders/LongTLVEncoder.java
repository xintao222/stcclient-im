 ...
 * 
 */
public class LongTLVEncoder extends AbstractNumberTLVEncoder implements
		TLVEncoder {

	// @SuppressWarnings("unused")
	// private static final Logger logger =
	// LoggerFactory.getLogger(LongTLVEncoder.class);
	...
	public List<byte[]> encode(Object from, TLVEncodeContext ctx) {
		...
		if (from instanceof Long) {
			...
			throw new RuntimeException("LongTLVEncoder: wrong source type. ["
					+ from.getClass() + "]");
		}
