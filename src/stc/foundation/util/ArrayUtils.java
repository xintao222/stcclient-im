...
public class ArrayUtils {
	 ...
	 * "{}"); }
	 * 
	 * public static String toString(Object array, String stringIfNull) { if
	 * (array == null) { return stringIfNull; } return new
	 * ToStringBuilder(array,
	...
	public static Object[] addAll(Object[] array1, Object[] array2) {
		...
		Object[] joinedArray = (Object[]) (Object[]) Array.newInstance(array1
	...
	public static boolean[] add(boolean[] array, boolean element) {
		boolean[] newArray = (boolean[]) (boolean[]) copyArrayGrow1(array,
				Boolean.TYPE);
	...
	public static char[] add(char[] array, char element) {
		char[] newArray = (char[]) (char[]) copyArrayGrow1(array,
				Character.TYPE);
		newArray[(newArray.length - 1)] = element;
		return newArray;
	}
	...
	public static double[] add(double[] array, double element) {
		double[] newArray = (double[]) (double[]) copyArrayGrow1(array,
				Double.TYPE);
		newArray[(newArray.length - 1)] = element;
		return newArray;
	}
	...
	public static char[] add(char[] array, int index, char element) {
		return (char[]) (char[]) add(array, index, new Character(element),
				Character.TYPE);
	}
	...
	public static short[] add(short[] array, int index, short element) {
		return (short[]) (short[]) add(array, index, new Short(element),
				Short.TYPE);
	}

	public static int[] add(int[] array, int index, int element) {
		return (int[]) (int[]) add(array, index, new Integer(element),
				Integer.TYPE);
	}
	...
	public static float[] add(float[] array, int index, float element) {
		return (float[]) (float[]) add(array, index, new Float(element),
				Float.TYPE);
	}

	public static double[] add(double[] array, int index, double element) {
		return (double[]) (double[]) add(array, index, new Double(element),
				Double.TYPE);
	}
