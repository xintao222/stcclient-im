...
public class PojoAsMapAdapter implements Map<String, Object> {
	...
	public void clear() {
		if (readonly) {
			throw new RuntimeException(
					"can't invoke clear method when readonly mode");
		}
		...
		for (Field field : fields.values()) {
			try {
				...
				// logger.error("failed to invoke set null for field [{}] bcs of {}",
				// field, e);
			}
		}
	}
	...
	public boolean containsValue(Object value) {
		for (Field field : fields.values()) {
			try {
				...
				// logger.error("failed to invoke get for field [{}] bcs of {}",
				// field, e);
			}
		}
	...
	public Object put(String key, Object value) {
		if (readonly) {
			throw new RuntimeException(
					"can't invoke put method when readonly mode");
		}
		...
		if (null != field) {
			try {
				...
				// logger.error("failed to invoke get/set for field [{}] bcs of {}",
				// field, e);
			}
		} else {
			// logger.warn("can't found field named [{}]", key);
